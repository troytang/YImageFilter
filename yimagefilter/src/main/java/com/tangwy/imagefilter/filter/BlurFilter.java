...
public class BlurFilter extends BaseFilter implements ImageFilter {
    ...
    public BlurFilter(int blurRadius, int iterations) {
    ...
    public BlurFilter iterations(int iterations) {
        mIterations = iterations;
        return this;
    }
    ...
    public Bitmap filter(Bitmap source, float percent) {
        ...
        for (int i = 0; i < mIterations; i++) {
            blur(inPixels, outPixels, width, changeHeight, mBlurRadius);
            blur(outPixels, inPixels, changeHeight, width, mBlurRadius);
        }
        blurFractional(inPixels, outPixels, width, changeHeight, mBlurRadius);
        blurFractional(outPixels, inPixels, changeHeight, width, mBlurRadius);
